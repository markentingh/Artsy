...
DROP INDEX IF EXISTS idx_printify_blueprint_images_bp_idx;
DROP INDEX IF EXISTS idx_printify_blueprint_images_bp_idx_color;
...
ALTER TABLE public."PrintifyBlueprintImages" DROP COLUMN IF EXISTS "Variants";
ALTER TABLE public."PrintifyBlueprintImages" DROP COLUMN IF EXISTS "VariantColor";