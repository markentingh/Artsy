...
const Projects = (args) => Api({ ...args }).endpoints(({ api }) => {
  ...
  return {
    ...
    editArtwork: (request) => api.post(`${apiPath}/edit-artwork`, request),
    ...
    deleteCollectionProductImage: (id) => api.post(`${apiPath}/delete-collection-product-image`, { id }),
    ...
    updatePlacementOptionalPrompt: (request) => api.post(`${apiPath}/update-placement-optional-prompt`, request),
    ...
    addCollectionProductImage: (request) => api.post(`${apiPath}/add-collection-product-image`, request),
    updateCollectionProductImageConfig: (request) => api.post(`${apiPath}/update-collection-product-image-config`, request),
    ...
    getMultiProductJson: (collectionId) => api.get(`${apiPath}/get-multi-product-json?collectionId=${collectionId}`),
    saveMultiProductJson: (request) => api.post(`${apiPath}/save-multi-product-json`, request),
    generateMultiProductInfo: (request) => api.post(`${apiPath}/generate-multi-product-info`, request),
