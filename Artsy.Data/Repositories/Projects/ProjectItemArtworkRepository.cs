...
namespace Artsy.Data.Repositories.Projects
{
    public class ProjectItemArtworkRepository : IProjectItemArtworkRepository
    {
        ...
        {
            const string query = @"SELECT * FROM public.""ProjectItemArtwork"" WHERE ""ProjectId"" = @projectId ORDER BY ""ItemId""";
        ...
        {
            const string query = @"SELECT * FROM public.""ProjectItemArtwork"" WHERE ""ItemId"" = @itemId";
