...
namespace Artsy.Data.Services
{
    public static class DapperStartupService
    {
        public static void AddDapperStartupService(this WebApplicationBuilder builder)
        {
            ...
            builder.Services.AddTransient<IProjectIdeaRepository, ProjectIdeaRepository>();
            builder.Services.AddTransient<IProjectIdeaVariationRepository, ProjectIdeaVariationRepository>();
            ...
            builder.Services.AddTransient<IProjectCollectionProductPlacementRepository, ProjectCollectionProductPlacementRepository>();
            ...
            builder.Services.AddTransient<IProjectCollectionArtworkReferenceRepository, ProjectCollectionArtworkReferenceRepository>();
